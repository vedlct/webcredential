                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="m-r-10"><img
                                                            src="{{url('public')}}/assets/images/product-pic.jpg"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="m-r-10"><img
                                                            src="{{url('public')}}/assets/images/product-pic-2.jpg"
                                                            alt="user" class="rounded" width="45"></div>
                                                </td>
                                                <td>Product #2</td>
                                                <td>id000002</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="m-r-10"><img
                                                            src="{{url('public')}}/assets/images/product-pic-3.jpg"
                                                            alt="user" class="rounded" width="45"></div>
                                                </td>
                                                <td>Product #3</td>
                                                <td>id000003</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="m-r-10"><img
                                                            src="{{url('public')}}/assets/images/product-pic-4.jpg"
                                                            alt="user" class="rounded" width="45"></div>
                                                </td>
                                                <td>Product #4</td>
                                                <td>id000004</td>
